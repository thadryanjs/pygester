...
- **`pages/page_NNNN.png`** — one rasterized image per page (21 total).
...
```bash
python scripts/01-parse.py "assets/Cortes-Gomez et al. - 2025 - Utility-Directed Conformal Prediction A Decision-Aware Framework for Actionable Uncertainty Quantif.pdf" --out <OUT_DIR> --formula-enrichment off --code-enrichment off --ocr off
